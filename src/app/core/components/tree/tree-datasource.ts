...
export class DynamicFlatNode {
    constructor(public item: ITreeNode, public level = 1, public expandable = false,
...
export class TreeDatasource {
  ...
  constructor(private _treeControl: FlatTreeControl<DynamicFlatNode>,
              private _database: TreeDynamicDatabase) {}
...
export abstract class TreeDynamicDatabase {
